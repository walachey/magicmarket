...
public:
   ...
   */  
  static void info_from_file_lwnn (const string & filename, int *npatterns,
				   int *ninput, int *noutput);
   ...
   */  
  static void info_from_file_fann (const string & filename, int *npatterns,
				   int *ninput, int *noutput);
   ...
   * Works only with lwnn format
   */
  static void load_patterns_lwnn (const string & filename,
					    float **inputs, float **targets,
					    int ninput, int noutput, int npatterns);
   ...
   * Works only with fann format
   */
  static void load_patterns_fann (const string & filename,
					    float **inputs, float **targets,
					    int ninput, int noutput, int npatterns);
