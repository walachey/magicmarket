...
public:
   ...
   */
  trainer (network * net, const string & error_filename =
   ...
   */
    trainer (const string & training_file, int hidden =
	     0, const string & error_filename =
	     "", const string & accuracy_filename = "",
  ...
  /*!\brief Retrieve a string describing the cause of stopping of last training
...
inline
string trainer::get_error_filename() const {
  return error_filename;
}

inline
string trainer::get_accuracy_filename() const {
